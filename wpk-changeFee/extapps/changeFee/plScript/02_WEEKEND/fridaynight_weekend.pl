...
open(RESULT, ">>C:/logs/changeFee/plLogs/02_WEEKEND/fridaynight_result_$timestamp.log") || die "can't create fridaynight_result.log\n";
...
## P60 요금 설정 ################################
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 11000, earlybird_max_fee = 11000, reg_dtm = GETDATE()
...
## P63 요금 설정 ################################
# 장비 교체 이후로 다래 car park 번호가 변경됐음
# my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 7000, earlybird_max_fee = 7000, reg_dtm = GETDATE()
...
## P122 요금 설정 ################################
#my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 6000, earlybird_max_fee = 6000, reg_dtm = GETDATE() 2017/12/23
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 5000, earlybird_max_fee = 5000, reg_dtm = GETDATE()
...
## P63 요금 설정 ################################
my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 7000, earlybird_max_fee = 7000, reg_dtm = GETDATE()
...
## P130 요금 설정 ################################
#my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 6000, earlybird_max_fee = 6000, reg_dtm = GETDATE() 2017/11/27
my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 10000, earlybird_max_fee = 10000, reg_dtm = GETDATE()
...
## P131 요금 설정 ################################
#my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 10000, earlybird_max_fee = 10000, reg_dtm = GETDATE()	2018/9/1
