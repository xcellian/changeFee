...
## P26 요금 설정 ################################
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 12000, earlybird_max_fee = 12000, reg_dtm = GETDATE()
...
## P65 요금 설정 ################################
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 30000, earlybird_max_fee = 20000, reg_dtm = GETDATE()
...
## P106 요금 설정 ################################
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 50000, earlybird_max_fee = 6000, reg_dtm = GETDATE()
...
## P116 요금 설정 ################################
my $cmd1 = $db1->prepare("update CPK_Payment set day_max_fee = 50000, earlybird_max_fee = 5000, reg_dtm = GETDATE()
...
## P130 요금 설정 ################################
my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 50000, earlybird_max_fee = 6000, reg_dtm = GETDATE()
...
## P133 요금 설정 ################################
my $cmd1 = $db2->prepare("update CPK_Payment set day_max_fee = 9000, earlybird_max_fee = 7000, reg_dtm = GETDATE()
